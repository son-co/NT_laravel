...
@section('slider')
    <div class="w-full h-full font-libre">
        ...
        <div class="flex flex-col justify-center items-center py-16 gap-12">
            ...
            <form action="{{route('log.registerUser')}}" method="post" class="font-libre flex flex-col justify-center items-center gap-5">
                ...
                <p class="text-neutral-400 tracking-tight  font-libre text-sm">Nếu bạn đã có tài khoản, vui lòng đăng đăng nhập <a href="{{route('log.logIn')}}" class="hover:underline font-bold cursor-pointer hover:italic text-neutral-14">tại đây</a></p>
