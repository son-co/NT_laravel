<div class="container h-full px-0 py-5">
    <div class="grid grid-cols-1 lg:grid-cols-6 gap-5 w-full h-full ">
        ...
        <div class="col-span-3 row-start-1 lg:row-auto lg:col-span-4 h-full w-full">
            <div class=" grid md:grid-cols-3 items-center gap-x-0 grid-cols-2">
                <div class="flex items-center col-span-1">
                    ...
                    <p class="px-3 py-2 w-full text-center text-base xl:px-5 xl:py-3 font-bold text-white xl:text-lg bg-neutral-14 inline-block">SẢN PHẨM NỔI BẬT</p>
            ...
            <div class="py-5 !h-[650px] w-full">
                <div class="swiper mySwiperdeal h-full w-full">
                    <div class="swiper-wrapper w-full">
                        <a href="" class="swiper-slide deal-hot flex-col  !flex justify-center items-center relative">             
                            <img src="./images/product/dongho1.png"   alt="">
                            <p class="name mt-4 hover:text-neutral-14">Đồng hồ Miso Limited</p>
                            <p class="price text-neutral-14 ">1.200.000đ</p>
                            <div class="absolute flex justify-center items-center gap-3 backdrop-blur-lg w-full h-48 top-5">
                        ...
                        <a href="" class="swiper-slide deal-hot flex-col !flex justify-center items-center">             
                            <img src="./images/product/dongho1.png"   alt="">
                            <p class="name mt-4 hover:text-neutral-14">Đồng hồ Miso Limited</p>
                            <p class="price text-neutral-14 ">1.200.000đ</p>
                        </a>
